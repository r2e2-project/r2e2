...
def main():
	...
	genKillerooTerrain("killeroo_terrain.pbrt",
	                   xres=args.xres,
	                   yres=args.yres,
	                   landxres =args.landxres,
	                   landyres = args.landyres,
	                   landiters=args.landiters,
	                   LookAt= args.LookAt,
	                   l_scale_coeff=args.land_scale,
	                   height_coeff=args.height_scale,
	                   k_coeff=args.k_coeff,
	                   num_killeroos_unique=args.num_killeroos_unique,
	                   num_killeroos_instance=args.num_killeroos_instance,
