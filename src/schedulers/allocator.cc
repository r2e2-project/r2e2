...
void Allocator::addTreelet( TreeletId id )
{
  unassignedTreelets.push_back( id );
}
...
bool Allocator::anyUnassignedTreelets()
{
  return !unassignedTreelets.empty();
}
